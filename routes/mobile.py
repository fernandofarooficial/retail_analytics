...
def dashboard():
    ...
    if active_store:
        ...
        if active_microvix_portal and active_store_cnpj:
            ...
            top5_tipo_dia = _top5_por_tipo(sid, active_microvix_portal, active_store_cnpj, data_str, data_str, data_str)
            top5_tipo_sem = _top5_por_tipo(sid, active_microvix_portal, active_store_cnpj, semana_inicio_str, semana_fim_str, semana_inicio_str)
            top5_tipo_mes = _top5_por_tipo(sid, active_microvix_portal, active_store_cnpj, mes_inicio_str, mes_fim_str, mes_inicio_str)
            top5_tipo_ytd = _top5_por_tipo(sid, active_microvix_portal, active_store_cnpj, ytd_inicio_str, ytd_fim_str, ytd_inicio_str)
    ...
    # ── Tema da empresa ──────────────────────────────────────────────────────
    theme = dict(primary_color='#F47B20', secondary_color='#0057A8', accent_color='#FFFFFF', text_color='#111827', background_color='#F5F5F5')
